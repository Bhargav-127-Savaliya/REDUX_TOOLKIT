...
const navigation = [
  { name: 'Dashboard', current: true, path: '/DashBoard' },
  { name: 'Home', current: false, path: '/' },
  { name: 'Cart', current: false, path: '/Cart' },
  // { name: 'Calendar', current: false, path: '/Cart' },
]
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    // src="https://pbs.twimg.com/profile_images/1080365925977665540/h9PChfwj_400x400.jpg"
                    alt="Your Company"
                  />
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  ...
                  <div className="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 border-2 border-red-500 rounded-full -top-2 -right-2">{items.length}</div>
                </button>
                {/* </Link> */}
                {/* Profile dropdown */}
